...
export default function SplashScreen({ onComplete }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-cyan-50 via-white to-teal-100 px-4 sm:px-6 transition-all duration-600 ease-out ${
